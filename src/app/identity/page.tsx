            ...
            {earlyDescs.length === 0 ? (
              ...
              <div className="space-y-3">
                {earlyDescs.map(([phrase, data]) => (
                  <div key={phrase}>
                    <p className="text-[14px] text-charcoal-700 italic">&ldquo;{phrase}&rdquo;</p>
        ...
        <div className="card p-5">
          <div className="space-y-1">
            {narrativeRepetition.value.slice(0, 10).map((phrase) => (
              <div key={phrase.phrase} className="flex items-center gap-3 py-2.5 border-b border-cream-100 last:border-0">
                <span className="text-[14px] text-charcoal-700 italic flex-1">
                  &ldquo;{phrase.phrase}&rdquo;
                </span>
                <span className="font-mono text-[12px] text-charcoal-400 w-8 text-right">
