  ...
  return (
    <div>
      ...
      <div className="reading-column px-6 pb-24">
        <div className="prose-body text-[15px] text-ink-700 leading-[1.8] mt-4 mb-10">
          <p>
        ...
        {isLoaded && activeProfile && (
          <div className="mt-10 pt-8 border-t border-linen-200 space-y-4">
            <p className="font-sans text-[11px] text-ink-400 tracking-widest uppercase mb-4">
              Continue with: {activeProfile.label}
            </p>
            <button
              onClick={() => router.push('/baseline')}
              className="block w-full text-left py-3 border-b border-linen-200 hover:border-charcoal-300 transition-colors duration-300"
            >
            ...
            <button
              ...
              className="block w-full text-left py-3 border-b border-linen-200 hover:border-charcoal-300 transition-colors duration-300"
            >
              <span className="text-[15px] text-ink-700">Go to timeline analysis</span>
              <span className="block text-[13px] text-ink-400 mt-0.5">
